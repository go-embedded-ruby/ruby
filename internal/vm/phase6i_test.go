...
func TestBignum(t *testing.T) {
	tests := []struct{ name, src, want string }{
		...
		{"literal", `p 99999999999999999999999999`, "99999999999999999999999999\n"},
		{"literal_class", `p 100000000000000000000.class`, "Integer\n"},
		{"literal_arith", `p 10000000000000000000 + 1`, "10000000000000000001\n"},
		{"literal_underscores", `p 1_000_000_000_000_000_000_000`, "1000000000000000000000\n"},
	}
