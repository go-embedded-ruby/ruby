...
func TestStringMethods(t *testing.T) {
	tests := []struct{ name, src, want string }{
		...
		{"byteslice_idx", `p "hello".byteslice(1)`, "\"e\"\n"},
		{"byteslice_len", `p "hello".byteslice(1, 3)`, "\"ell\"\n"},
		{"byteslice_neg", `p "hello".byteslice(-2, 2)`, "\"lo\"\n"},
		{"byteslice_oob", `p "hello".byteslice(10)`, "nil\n"},
		{"byteslice_neg_len", `p "hello".byteslice(0, -1)`, "nil\n"},
		{"byteslice_at_end", `p "abc".byteslice(3)`, "nil\n"},
		{"byteslice_end_zero", `p "abc".byteslice(3, 0)`, "\"\"\n"},
		{"byteslice_clamp", `p "abc".byteslice(2, 5)`, "\"c\"\n"},
		{"byteslice_neg_oob", `p "abc".byteslice(-4)`, "nil\n"},
		{"byteslice_range", `p "hello".byteslice(1..3)`, "\"ell\"\n"},
		{"byteslice_range_excl", `p "hello".byteslice(1...3)`, "\"el\"\n"},
		{"byteslice_multibyte", `p "héllo".byteslice(1, 2)`, "\"é\"\n"},
		{"byteslice_range_oob", `p "abc".byteslice(5..7)`, "nil\n"},
