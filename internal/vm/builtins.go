...
func (vm *VM) bootstrap() {
	...
	vm.registerActiveLdap()       // ActiveLdap ORM: Connection/Model/Record + ldap_mapping/find/save/to_ldif (require "active_ldap"), backed by go-ruby-activeldap; Directory seam is the library MockDirectory or a Net::LDAP-shaped object (go-ruby-ldap); needs StandardError for ActiveLdap::Error
